module Admin
  class MediaController < Admin::ApplicationController
    before_action :set_medium, only: [:approve, :destroy, :update]
 ...
 def edit
    ...
    def update
      ...
      if @media.update(media_params)
        redirect_to screenshots_admin_media_path, notice: 'Media updated successfully.'
      else
        render :edit
      end
    end
    ...
    def media_params
      params.require(:medium).permit(:file, :meta_description, :meta_keywords, :category, :screenshot_of_week, :approved, :shard_id)
    end
  end
end
